    ...
    run: async (client, message, args) => {
        try {
            ...
            .setFooter('RBSW rules page 3/4'),
                ...
                .addField('**Rule number 14:**', 'Some smart boys/girls under us know how to exploit punishments given to them. This is strickly forbitten and will result in a punishment of a higher degree.')
