    ...
    run: async (client, message, args) => {
        try {
            ...
            new rm.menu(message.channel, message.author.id, [
                ...
                .addField('**Rule number 10:**', 'This is an English speaking server, so the only accepted language in chats is English. Excluding specific rooms like "French" / "Dutch". To enter a hidden channel like these write `!rank [language]`.')
